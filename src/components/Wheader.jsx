             ...
             <div  className="lite-topbar main-top">
               <div  className="nav-top">
                ...
                <a href="index.html" className="nav-search unlogin-search">
                 <aside >
                  <label  className="m-search"><i  className="m-font m-font-search"></i> 
                   <div  className="m-text-cut">
                     大家都在搜：#lisa短发# 
                   </div></label>
                 </aside></a> 
                            ...
                            <ul  className="nav_item">
                              {
                                (()=>{
                                    return this.state.navs.map((item,index)=>{
                                        return (
                                            <li onClick={this.navigateTo.bind(this,index)} key={index} className={index===this.state.nav?"item_li cur":"item_li"}>
